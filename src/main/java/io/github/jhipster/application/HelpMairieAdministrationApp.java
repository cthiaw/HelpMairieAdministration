...
public class HelpMairieAdministrationApp {

    private static final Logger log = LoggerFactory.getLogger(HelpMairieAdministrationApp.class);

    private final Environment env;

    public HelpMairieAdministrationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes HelpMairieAdministration.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HelpMairieAdministrationApp.class);
